# Generated by Django 3.2.25 on 2026-06-16 12:36
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('employee_id', models.IntegerField(default=0, max_length=100)),
                ('manager_id', models.IntegerField(default=0, max_length=100)),
                ('title', models.CharField(default='No Title', max_length=200)),
                ('details', models.TextField(default='Details not provided', max_length=100)),
